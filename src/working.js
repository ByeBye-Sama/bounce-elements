...
function doPhysics(boxes, width, height, dt) {
  for (let i = 0; i < boxes.length; i++) {
    ...
    // if (box.x + radius >= canvas.width || box.x - radius <= 0) {
    //   box.dx = -box.dx;
    // }

    // if (box.y + radius >= canvas.height || box.y - radius <= 0) {
    //   box.dy = -box.dy;
    // }

    // if (box.x + box.dx > canvas.width - radius || box.x + box.dx < radius) {
    //   box.dx = -box.dx;
    // }
    // if (box.y + box.dy > canvas.height - radius || box.y + box.y < radius) {
    //   box.dy = -box.dy;
    // }
  }
